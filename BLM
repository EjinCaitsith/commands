			...
			elseif command == 'waters2' then
                send_command('input /echo Waiting; wait 2.5; input //hp warp Windurst Waters 2')
                add_to_chat(158,'Windurst Waters 2')
			elseif command == 'waters3' then
                send_command('input /echo Waiting; wait 2.5; input //hp warp Windurst Waters 3')
                add_to_chat(158,'Windurst Waters 3')
			elseif command == 'woods2' then
                send_command('input /echo Waiting; wait 2.5; input //hp warp Windurst Woods 2')
		...
		elseif command == 'entry' then
				send_command('input /ja "Dark Arts" <me>; wait 2; input /ja "Addendum: Black" <me>')				
		...
		elseif command == 'b1' then
				send_command('input /echo waiting; wait 6.5; input /ma "blizzaja" <bt>; wait 4.8; input /ma "blizzard VI" <bt>')				
				add_to_chat(158,'blizz SC')
		elseif command == 'b2' then
				send_command('input /echo waiting; wait 6.5; input /ma "blizzaja" <bt>; wait 4.8; input /ma "blizzard VI" <bt>')				
				add_to_chat(158,'blizz SC')
		elseif command == 'f1' then
				send_command('input /echo waiting; wait 5.5; input /ma "firaja" <bt>; wait 4.8; input /ma "fire VI" <bt>')				
				add_to_chat(158,'fire SC')
		elseif command == 'f2' then
				send_command('input /echo waiting; wait 5.5; input /ma "firaja" <bt>; wait 4.8; input /ma "fire VI" <bt>')				
				add_to_chat(158,'fire SC')
		elseif command == 'a1' then
				send_command('input /echo waiting; wait 5.5; input /ma "aeroja" <bt>; wait 4.8; input /ma "aero VI" <bt>')				
				add_to_chat(158,'aero SC')
		elseif command == 'a2' then
				send_command('input /echo waiting; wait 5.5; input /ma "aeroja" <bt>; wait 4.8; input /ma "aero VI" <bt>')				
				add_to_chat(158,'aero SC')
		elseif command == 't1' then
				send_command('input /echo waiting; wait 5.5; input /ma "thundaja" <bt>; wait 4.8; input /ma "thunder VI" <bt>')				
				add_to_chat(158,'thunder SC')
		elseif command == 't2' then
				send_command('input /echo waiting; wait 5.5; input /ma "thundaja" <bt>; wait 4.8; input /ma "thunder VI" <bt>')				
				add_to_chat(158,'thunder SC')
		elseif command == 's1' then
				send_command('input /echo waiting; wait 6.5; input /ma "stoneja" <bt>; wait 4.8; input /ma "stone VI" <bt>')				
				add_to_chat(158,'stone SC')
		elseif command == 's2' then
				send_command('input /echo waiting; wait 6.5; input /ma "stoneja" <bt>; wait 4.8; input /ma "stone VI" <bt>')				
				add_to_chat(158,'stone SC')
		elseif command == 'wa1' then
				send_command('input /echo waiting; wait 5.5; input /ma "waterja" <bt>; wait 4.8; input /ma "water VI" <bt>')				
				add_to_chat(158,'water SC')
